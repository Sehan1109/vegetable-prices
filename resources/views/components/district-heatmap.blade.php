...
>
    ...
    <!-- =========================================================================
         ...
         ========================================================================= -->
    <div x-show="serverLoading && !offlineFallback" class="absolute inset-0 z-50 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-3xl p-10 flex flex-col items-center justify-center min-h-[500px]" id="heatmap-loader">
        <div class="relative flex flex-col items-center justify-center space-y-6">
            ...
            <div class="text-center space-y-2">
                <h4 class="font-extrabold text-slate-900 dark:text-white tracking-tight text-lg">Synchronizing Geographical Database...</h4>
                <p class="text-slate-600 dark:text-slate-400 text-xs max-w-sm">
    ...
    <div x-show="serverError && !offlineFallback" class="absolute inset-0 z-50 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-3xl p-8 max-w-xl mx-auto flex flex-col items-center justify-center text-center space-y-6 shadow-3xs" id="heatmap-error">
        ...
        <div class="space-y-2 text-center">
            <h4 class="font-extrabold text-slate-900 dark:text-white text-lg">Database Ingestion Failure</h4>
    ...
    <div x-show="!serverLoading || offlineFallback" class="space-y-8" x-transition.opacity.duration.500ms>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            <!-- Card 1 -->
            <div class="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl p-5 shadow-3xs hover:shadow-2xs transition-all relative overflow-hidden">
                ...
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <h3 class="text-3xl font-black font-mono text-slate-900 dark:text-white mt-1">Rs. <span x-text="nationalStats.nationalAverage"></span></h3>
                        <p class="text-[11px] text-slate-500 dark:text-slate-400 mt-1 leading-snug">Average price index calculated across all 12 trading districts.</p>
                    </div>
                    <div class="w-9 h-9 rounded-xl bg-emerald-50 flex items-center justify-center text-emerald-600 shrink-0">
                        <i data-lucide="dollar-sign" class="w-4 h-4"></i>
                    </div>
                </div>
                <div class="mt-4 pt-3 border-t border-slate-50 dark:border-slate-700 flex items-center justify-between text-[11px] font-mono text-slate-400">
                    <span>Historical Baseline:</span>
                    <span class="font-bold text-slate-600 dark:text-slate-300">Rs. 320/kg</span>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl p-5 shadow-3xs hover:shadow-2xs transition-all relative overflow-hidden">
                ...
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-2xl font-black font-mono text-slate-900 dark:text-white mt-0.5">Rs. <span x-text="nationalStats.expensivePrice"></span> <span class="text-xs text-slate-400 font-normal">/kg</span></p>
                    </div>
                    <div class="w-9 h-9 rounded-xl bg-rose-50 flex items-center justify-center text-rose-600 shrink-0">
                        <i data-lucide="trending-up" class="w-4 h-4"></i>
                    </div>
                </div>
                <div class="mt-2.5 text-[11px] text-slate-500 dark:text-slate-400 leading-none">Suffers transit premiums & structural markups.</div>
            </div>
            ...
            <div class="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl p-5 shadow-3xs hover:shadow-2xs transition-all relative overflow-hidden">
                ...
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-2xl font-black font-mono text-slate-900 dark:text-white mt-0.5">Rs. <span x-text="nationalStats.cheapestPrice"></span> <span class="text-xs text-slate-400 font-normal">/kg</span></p>
                    </div>
                    <div class="w-9 h-9 rounded-xl bg-emerald-50 flex items-center justify-center text-emerald-600 shrink-0">
                        <i data-lucide="trending-down" class="w-4 h-4"></i>
                    </div>
                </div>
                <div class="mt-2.5 text-[11px] text-slate-500 dark:text-slate-400 leading-none">Advantaged farmgate production yields.</div>
            </div>
            ...
            <div class="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-2xl p-5 shadow-3xs hover:shadow-2xs transition-all relative overflow-hidden">
                ...
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <h3 class="text-xl font-black font-mono text-slate-900 dark:text-white mt-1">Dispersion Levels</h3>
                ...
                <div class="mt-2 text-[10px] text-slate-400 dark:text-slate-400">
        ...
        <!-- =========================================================================
             ...
             ========================================================================= -->
        <div class="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-3xl p-5 sm:p-8 shadow-xs">
            
            <div class="flex flex-col md:flex-row md:items-center justify-between pb-6 mb-8 border-b border-slate-100 dark:border-slate-700 gap-4">
                <div>
                    ...
                    <h2 class="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white font-display tracking-tight">Ceylon Price Dispersion Projection</h2>
                    <p class="text-slate-500 dark:text-slate-400 text-xs sm:text-sm mt-1 max-w-xl">An interactive geospatial heatmap showcasing real LKR vegetable price distributions, agrarian roles, and high-altitude production centers.</p>
                </div>

                <div class="flex bg-slate-100 dark:bg-slate-700 p-1 rounded-xl border border-slate-200 dark:border-slate-600 self-start md:self-center h-10 shadow-3xs animate-fade-in">
                    <button @click="displayMode = 'prices'" :class="displayMode === 'prices' ? 'bg-white dark:bg-slate-600 text-slate-800 dark:text-white shadow-3xs font-semibold' : 'text-slate-550 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'" class="px-3 py-1.5 rounded-lg text-xs font-bold font-sans transition-all flex items-center gap-1.5 cursor-pointer select-none">
                        <i data-lucide="layers" class="w-3.5 h-3.5 text-emerald-600"></i> Price Multipliers
                    </button>
                    <button @click="displayMode = 'supply-roles'" :class="displayMode === 'supply-roles' ? 'bg-white dark:bg-slate-600 text-slate-800 dark:text-white shadow-3xs font-semibold' : 'text-slate-550 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'" class="px-3 py-1.5 rounded-lg text-xs font-bold font-sans transition-all flex items-center gap-1.5 cursor-pointer select-none">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                ...
                <div class="lg:col-span-5 flex flex-col justify-between space-y-6">
                    <div class="space-y-6">
                        <div class="bg-slate-50 dark:bg-slate-700 rounded-2xl p-4 border border-slate-100 dark:border-slate-600">
                            <h3 class="font-bold text-slate-800 dark:text-white text-xs font-display mb-1.5 flex items-center gap-1.5">
                                <i data-lucide="info" class="w-3.5 h-3.5 text-indigo-500"></i> <span>How to Interoperate:</span>
                            </h3>
                            <p class="text-slate-500 dark:text-slate-300 text-xs leading-relaxed">
                        ...
                        <div class="space-y-2.5">
                            ...
                            <div class="flex flex-wrap items-center gap-1 bg-slate-50 dark:bg-slate-700 p-1 rounded-xl border border-slate-150 dark:border-slate-600 max-w-xl">
                                <template x-for="cat in categories" :key="cat.id">
                                    <button 
                                        @click="selectedCategory = cat.id"
                                        :class="selectedCategory === cat.id ? 'bg-white dark:bg-slate-600 text-slate-900 dark:text-white shadow-2xs font-semibold' : 'text-slate-550 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white'"
                    ...
                    <!-- Callout Panel -->
                    <div class="bg-emerald-600 text-white rounded-3xl p-6 border border-emerald-700 shadow-md relative overflow-hidden flex flex-col justify-between min-h-[280px] dark:bg-slate-900 dark:text-white dark:border-slate-800">
                        <div class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-emerald-500/20 to-transparent rounded-full -mr-10 -mt-10 pointer-events-none dark:from-emerald-500/10"></div>
                        
                        <div class="space-y-5 relative z-10">
                            <div class="flex justify-between items-center bg-emerald-700 dark:bg-slate-850 py-1.5 px-3 rounded-xl border border-emerald-800 dark:border-slate-800 self-start">
                ...
                <div class="lg:col-span-7 flex flex-col items-center justify-center relative p-3 bg-slate-50 dark:bg-slate-900/40 rounded-2.5xl border border-slate-100 dark:border-slate-800 min-h-[500px]">
                    ...
                    <div 
                        ...
                        class="absolute top-4 right-4 bg-white text-slate-900 border border-slate-200 rounded-xl p-3 shadow-lg z-20 w-52 text-[11px] pointer-events-none dark:bg-slate-900 dark:text-white dark:border-slate-800"
                    >
                        <template x-if="hoveredDistrict">
                            <div>
                                <div class="flex justify-between items-start border-b border-slate-200 dark:border-slate-800 pb-1 mb-1.5">
                                    <div>
                                        <h5 class="font-bold text-[11.5px]" x-text="hoveredDistrict.name"></h5>
                                        <span class="text-[8.5px] text-slate-600 dark:text-slate-450 font-mono uppercase font-semibold" x-text="hoveredDistrict.province"></span>
                                    </div>
                                    <span class="bg-slate-800 text-emerald-400 text-[8px] font-mono px-1 rounded">Spot</span>
                                </div>
                                <div class="space-y-1 font-mono">
                                    <div class="flex justify-between">
                                        <span class="text-slate-600 dark:text-slate-450 text-[10px]">Avg LKR Rate:</span>
                                        <strong class="text-slate-900 dark:text-white">Rs.<span x-text="hoveredDistrict.computedAveragePrice"></span>/kg</strong>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-slate-600 dark:text-slate-450 text-[10px]">Highest crop:</span>
                                        <span class="text-rose-400 text-[9.5px] truncate max-w-[85px]" x-text="hoveredDistrict.highestCropName"></span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-slate-600 dark:text-slate-450 text-[10px]">Lowest crop:</span>
                    ...
                    <div class="absolute bottom-6 left-6 flex items-center gap-2 select-none opacity-45 pointer-events-none">
                        ...
                        <div class="font-mono text-[9px] text-slate-450 leading-none">
                            <span class="block font-bold text-slate-600 dark:text-slate-450">CEYLON PROJECTION</span>
                            <span class="block mt-0.5 text-[8px]">07° 52' N, 80° 46' E</span>
                        </div>
                    </div>

                    <!-- Legend -->
                    <div class="relative sm:absolute sm:top-4 sm:left-4 bg-white/95 dark:bg-slate-900/90 backdrop-blur-md border border-slate-200/80 dark:border-slate-700 rounded-2xl p-3 text-[9.5px] font-mono text-slate-650 dark:text-slate-400 z-10 shadow-3xs w-full sm:w-auto mt-2 sm:mt-0 mb-4 sm:mb-0">
                        <template x-if="displayMode === 'prices'">
                            <div class="text-slate-600 dark:text-slate-400">
                                <span class="font-bold text-slate-800 dark:text-slate-200 uppercase tracking-wider block border-b border-slate-100 dark:border-slate-700 pb-1 mb-1.5">Map Color Calibration</span>
                        ...
                        <template x-if="displayMode === 'supply-roles'">
                            <div class="text-slate-600 dark:text-slate-400">
                                <span class="font-bold text-slate-800 dark:text-slate-200 uppercase tracking-wider block border-b border-slate-100 dark:border-slate-700 pb-1 mb-1.5">Agrarian Sector Legend</span>
                    ...
                    <div class="w-full max-w-[280px] xs:max-w-[325px] sm:max-w-[420px] aspect-[450/793] relative select-none">
                        <svg viewBox="0 0 450 793" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-full drop-shadow-lg">
                            ...
                            <g filter="url(#subtle-shadow)">
                                <path d="M 120 10 Q 180 30 200 100 Q 250 150 280 250 Q 320 300 350 400 Q 370 500 340 600 Q 300 750 250 780 Q 200 790 100 750 Q 50 650 30 500 Q 10 350 50 200 Q 80 100 120 10 Z" fill="#e2e8f0" fill-opacity="0.5" stroke="#cbd5e1" stroke-width="2" class="dark:fill-[#cbd5e1] dark:fill-opacity-20 dark:stroke-[#FFFFFF]" />
                            </g>
...
+                                         :class="{
+                                             'fill-slate-950 dark:fill-white font-black text-[8.5px]': selectedDistrictId === dist.id, 
+                                             'fill-slate-800 dark:fill-slate-200 text-[8px]': hoveredDistrictId === dist.id, 
+                                             'fill-slate-650 dark:fill-slate-400 font-bold opacity-80 text-[7.2px]': selectedDistrictId !== dist.id && hoveredDistrictId !== dist.id
+                                         }"
        ...
        <!-- =========================================================================
             ...
             ========================================================================= -->
        <section class="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-3xl p-5 sm:p-8 shadow-xs">
            <div class="flex flex-col md:flex-row md:items-center justify-between pb-6 mb-6 border-b border-slate-200 dark:border-slate-700 gap-3">
                <div>
                    ...
                    <h3 class="text-xl font-bold font-display text-slate-900 dark:text-white">District Price Comparison Portal</h3>
                    <p class="text-slate-500 dark:text-slate-400 text-xs mt-0.5">Select any two administrative zones of Sri Lanka to run side-by-side spot analysis and premium delta evaluations.</p>
                </div>

                <div class="flex flex-wrap items-center gap-2">
                    <div class="flex items-center gap-1.5 bg-slate-50 dark:bg-slate-700 p-1.5 rounded-xl border border-slate-150 dark:border-slate-600">
                        <label for="compare-a" class="text-[10px] font-mono text-slate-400 uppercase font-bold pl-1.5">HUB A:</label>
                        <select id="compare-a" x-model="compareDistrictIdA" class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-xs font-semibold text-slate-800 dark:text-white py-1 px-2 rounded-lg cursor-pointer max-w-[140px] focus:outline-none focus:ring-2 focus:ring-emerald-500">
                    ...
                    <div class="flex items-center gap-1.5 bg-slate-50 dark:bg-slate-700 p-1.5 rounded-xl border border-slate-150 dark:border-slate-600">
                        ...
                        <select id="compare-b" x-model="compareDistrictIdB" class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-xs font-semibold text-slate-800 dark:text-white py-1 px-2 rounded-lg cursor-pointer max-w-[140px] focus:outline-none focus:ring-2 focus:ring-emerald-500">
            ...
            <!-- Empty State / Warning -->
            <div x-show="compareDistrictIdA === compareDistrictIdB" class="py-10 text-center text-slate-400 dark:text-slate-400 text-xs font-semibold border border-dashed border-slate-200 dark:border-slate-700 rounded-2xl bg-slate-50 dark:bg-slate-700">
            ...
            <div x-show="compareDistrictIdA !== compareDistrictIdB" class="grid grid-cols-1 md:grid-cols-12 gap-6 items-stretch">
                ...
                <!-- District A Card -->
                <div class="md:col-span-5 bg-gradient-to-b from-slate-50 to-white border border-slate-150 rounded-2xl p-5 relative overflow-hidden dark:from-slate-700 dark:to-slate-800 dark:border-slate-600">
                    ...
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <h4 class="text-lg font-bold font-display text-slate-900 dark:text-white mt-2" x-text="compareA.name"></h4>
                            <p class="text-xs text-slate-400 dark:text-slate-300 mt-0.5" x-text="compareA.province"></p>
                        </div>
                    ...
                    <div class="mt-6 space-y-4">
                        <div class="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-700 p-4.5 rounded-xl shadow-3xs flex justify-between items-center">
                            <div>
                                <span class="text-[10px] font-mono text-slate-400 block uppercase font-bold">CALCULATED VALUATION</span>
                                <strong class="text-2xl font-mono text-slate-900 dark:text-white mt-1 block">Rs. <span x-text="compareA.computedAveragePrice"></span> /kg</strong>
                            </div>
                        ...
                        <div class="grid grid-cols-2 gap-3 text-xs">
                            <div class="border border-slate-100 dark:border-slate-700 p-3 rounded-xl bg-white dark:bg-slate-900">
                                <span class="text-[9px] font-mono text-rose-500 font-bold block">▲ PEAK COMMODITY</span>
                                <strong class="text-slate-800 dark:text-white block truncate mt-0.5 font-bold" x-text="compareA.highestCropName"></strong>
                            ...
                            <div class="border border-slate-100 dark:border-slate-700 p-3 rounded-xl bg-white dark:bg-slate-900">
                                ...
                                <strong class="text-slate-800 dark:text-white block truncate mt-0.5 font-bold" x-text="compareA.lowestCropName"></strong>
                ...
                <div class="md:col-span-2 flex flex-col justify-center items-center text-center p-4 bg-slate-50 dark:bg-slate-700 border border-slate-150 dark:border-slate-600 rounded-2xl">
                    ...
                    <div class="space-y-4 w-full">
                        <div>
                            ...
                            <strong class="text-sm font-black mt-1 font-mono text-slate-850 dark:text-white block">Rs. <span x-text="compareGapAbs"></span> /kg</strong>
                        </div>
                        <div class="p-3 rounded-xl bg-white dark:bg-slate-900 border border-slate-150 dark:border-slate-700 shadow-3xs text-center">
                            <span class="text-[8px] font-mono text-slate-400 block font-bold uppercase">PRICE VERDICT</span>
                            <p class="text-xs font-bold text-slate-800 dark:text-white mt-1 leading-normal">
                ...
                <div class="md:col-span-5 bg-gradient-to-b from-slate-50 to-white border border-slate-150 rounded-2xl p-5 relative overflow-hidden dark:from-slate-700 dark:to-slate-800 dark:border-slate-600">
                    ...
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <h4 class="text-lg font-bold font-display text-slate-900 dark:text-white mt-2" x-text="compareB.name"></h4>
                            <p class="text-xs text-slate-400 dark:text-slate-300 mt-0.5" x-text="compareB.province"></p>
                        </div>
                    ...
                    <div class="mt-6 space-y-4">
                        <div class="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-700 p-4.5 rounded-xl shadow-3xs flex justify-between items-center">
                            <div>
                                <span class="text-[10px] font-mono text-slate-400 block uppercase font-bold">CALCULATED VALUATION</span>
                                <strong class="text-2xl font-mono text-slate-900 dark:text-white mt-1 block">Rs. <span x-text="compareB.computedAveragePrice"></span> /kg</strong>
                            </div>
                            <div class="text-right">
                                <span class="text-[9px] font-mono text-slate-400 uppercase font-semibold block">Week trend</span>
                        ...
                        <div class="grid grid-cols-2 gap-3 text-xs">
                            <div class="border border-slate-100 dark:border-slate-700 p-3 rounded-xl bg-white dark:bg-slate-900">
                                <span class="text-[9px] font-mono text-rose-500 font-bold block">▲ PEAK COMMODITY</span>
                                <strong class="text-slate-800 dark:text-white block truncate mt-0.5 font-bold" x-text="compareB.highestCropName"></strong>
                                <span class="text-slate-500 font-mono text-[10.5px]">Rs. <span x-text="compareB.highestCropPrice"></span> /kg</span>
                            </div>
                            <div class="border border-slate-100 dark:border-slate-700 p-3 rounded-xl bg-white dark:bg-slate-900">
                                <span class="text-[9px] font-mono text-emerald-500 font-bold block">▼ BASE COMMODITY</span>
                                <strong class="text-slate-800 dark:text-white block truncate mt-0.5 font-bold" x-text="compareB.lowestCropName"></strong>
    ...
    <div x-show="showGlassModal" style="display: none;" class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div 
            ...
            class="relative w-full max-w-xl backdrop-blur-xl bg-white/80 border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.4)] overflow-hidden z-10 text-slate-900 dark:bg-slate-950/80 dark:border-white/10 dark:text-white"
        >
            <!-- Glowing Orbs -->
            <div class="absolute -top-1/4 -right-1/4 w-72 h-72 bg-emerald-500/20 rounded-full blur-3xl pointer-events-none dark:bg-emerald-500/15"></div>
            <div class="absolute -bottom-1/4 -left-1/4 w-72 h-72 bg-blue-500/15 rounded-full blur-3xl pointer-events-none dark:bg-blue-500/10"></div>

            <button @click="showGlassModal = false" type="button" class="absolute top-4 right-4 p-2 bg-slate-100 hover:bg-slate-200 border border-slate-200 hover:border-slate-300 rounded-full transition-all cursor-pointer flex items-center justify-center text-slate-600 hover:text-slate-900 dark:bg-white/5 dark:hover:bg-white/10 dark:border-white/10 dark:hover:border-white/25 dark:text-slate-300 dark:hover:text-white">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6 relative z-10 text-slate-900 dark:text-white">
                <div class="bg-slate-50 border border-slate-200 rounded-2xl p-4 backdrop-blur-md relative overflow-hidden flex flex-col justify-between dark:bg-white/5 dark:border-white/10">
                    <div>
                        ...
                        <strong class="text-3xl font-mono font-black text-slate-900 block mt-3 dark:text-white">
                            Rs. <span x-text="selectedDistrict.computedAveragePrice"></span> <span class="text-xs text-slate-400 font-normal">/kg</span>
                        </strong>
                    </div>
                    <p class="text-[10px] text-slate-600 mt-2 dark:text-slate-450">Calculated from active central market trading nodes.</p>
                </div>
                ...
                <div class="bg-slate-50 border border-slate-200 rounded-2xl p-4 backdrop-blur-md relative overflow-hidden flex flex-col justify-between dark:bg-white/5 dark:border-white/10">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <strong :class="selectedDistrict.trendPercent <= 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-450'" class="text-2xl font-mono font-black block mt-3">
                                <span x-text="selectedDistrict.trendPercent <= 0 ? '-' : '+'"></span><span x-text="Math.abs(selectedDistrict.trendPercent) + '%'"></span>
                            </strong>
                        </div>
                        <div :class="selectedDistrict.trendPercent <= 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-400'" class="p-2 rounded-xl bg-slate-100 border border-slate-200 dark:bg-white/5 dark:border-white/10">
                            <i :data-lucide="selectedDistrict.trendPercent <= 0 ? 'trending-down' : 'trending-up'" class="w-5 h-5"></i>
                        </div>
                    </div>
                    <p class="text-[10px] text-slate-600 mt-2 dark:text-slate-450">Delta relative to previous week's baseline (Rs. <span x-text="selectedDistrict.computedAveragePricePrevWeek"></span>).</p>
                </div>
            </div>

            <div class="space-y-3 mb-6 relative z-10 text-slate-900 dark:text-white">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                    <div class="bg-slate-50 border border-emerald-500/30 rounded-xl p-3.5 backdrop-blur-sm dark:bg-white/5 dark:border-emerald-500/20">
                        ...
                        <h5 class="font-bold text-[13px] text-slate-900 mt-1.5 truncate dark:text-white" x-text="selectedDistrict.lowestCropName"></h5>
                        <strong class="text-emerald-600 font-mono text-[12px] mt-0.5 block dark:text-emerald-300">Rs. <span x-text="selectedDistrict.lowestCropPrice"></span> /kg</strong>
                    </div>

                    <div class="bg-slate-50 border border-rose-500/30 rounded-xl p-3.5 backdrop-blur-sm dark:bg-white/5 dark:border-rose-500/20">
                        ...
                        <h5 class="font-bold text-[13px] text-slate-900 mt-1.5 truncate dark:text-white" x-text="selectedDistrict.highestCropName"></h5>
                        <strong class="text-rose-600 font-mono text-[12px] mt-0.5 block dark:text-rose-300">Rs. <span x-text="selectedDistrict.highestCropPrice"></span> /kg</strong>
                    </div>
                </div>
            </div>

            <div class="bg-slate-50 border border-slate-200 rounded-2xl p-4.5 backdrop-blur-md relative z-10 dark:bg-white/5 dark:border-white/10">
                ...
                <div class="flex flex-wrap gap-2">
                    <template x-for="crop in selectedDistrict.primaryCrops" :key="crop">
                        <span class="px-2.5 py-1 text-xs font-semibold bg-slate-100 border border-slate-200 text-emerald-600 rounded-lg transition-all hover:bg-slate-200 dark:bg-white/5 dark:border-white/10 dark:text-emerald-200 dark:hover:bg-white/10" x-text="crop"></span>
                    </template>
                </div>
            </div>

            <div class="mt-6 flex justify-end relative z-10">
                <button @click="showGlassModal = false" type="button" class="px-5 py-2.5 text-xs font-semibold rounded-xl bg-white text-slate-950 hover:bg-slate-100 transition-all cursor-pointer shadow-md text-center dark:bg-white dark:text-slate-950 dark:hover:bg-slate-100">
                    Dismiss HUD
                </button>
            </div>
        </div>
