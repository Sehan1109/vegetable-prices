    ...
    <template x-if="basket.length > 0">
        <div class="space-y-6">
            ...
            <div class="bg-slate-900 text-white rounded-2xl p-5 shadow-lg relative overflow-hidden">
                <div class="absolute -right-10 -bottom-10 w-32 h-32 rounded-full bg-emerald-500/10 blur-xl pointer-events-none"></div>
                <div class="absolute left-1/3 top-0 w-24 h-24 rounded-full bg-slate-800/60 blur-lg pointer-events-none"></div>

                <div class="relative flex justify-between items-baseline mb-4">
                    <span class="text-xs font-mono tracking-wider uppercase text-slate-400" x-text="translations[lang].basketEstimatedTotal"></span>
                    <div class="text-right">
                        <span class="text-3xl font-black tracking-tight text-emerald-400 font-mono">
                ...
                <div class="border-t border-slate-800 pt-3 flex items-center gap-2.5 text-xs text-slate-400">
            ...
            <div class="space-y-3">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-2">
                    <template x-for="comparison in marketComparisons" :key="comparison.marketId">
                        <div class="flex flex-col justify-between p-3 rounded-xl border text-xs transition-all"
                             :class="comparison.marketId === currentMarket.id ? 'border-emerald-500 bg-emerald-50/10 ring-1 ring-emerald-500/20' : 'border-slate-100 bg-white hover:border-slate-200 shadow-3xs'">
