<x-admin-layout>
    @slot('header')
        Edit Market: {{ $market->name }}
    @endslot

    <div class="max-w-2xl">
        <form action="{{ route('admin.markets.update', $market) }}" method="POST" class="bg-[#111827] border border-gray-800 rounded-xl shadow-2xl overflow-hidden">
            @csrf
            @method('PUT')
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $market->name) }}" required class="mt-1 block w-full border-gray-700 bg-[#0a101d] text-gray-300 rounded-md shadow-sm focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="district" id="district" value="{{ old('district', $market->district) }}" required class="mt-1 block w-full border-gray-700 bg-[#0a101d] text-gray-300 rounded-md shadow-sm focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm">
                    ...
                    <div>
                        ...
                        <input type="text" name="province" id="province" value="{{ old('province', $market->province) }}" required class="mt-1 block w-full border-gray-700 bg-[#0a101d] text-gray-300 rounded-md shadow-sm focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm">
                ...
                <div>
                    ...
                    <input type="text" name="coordinates" id="coordinates" value="{{ old('coordinates', $market->coordinates) }}" placeholder="e.g. 6.9271, 79.8612" class="mt-1 block w-full border-gray-700 bg-[#0a101d] text-gray-300 rounded-md shadow-sm focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm">
                ...
                <div>
                    ...
                    <input type="text" name="slug" id="slug" value="{{ old('slug', $market->slug) }}" required class="mt-1 block w-full border-gray-700 bg-[#0a101d] text-gray-300 rounded-md shadow-sm focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm">
