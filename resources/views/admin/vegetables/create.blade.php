<x-admin-layout>
    ...
    <div class="max-w-2xl">
        <form action="{{ route('admin.vegetables.store') }}" method="POST" enctype="multipart/form-data" class="bg-[#111827] border border-gray-800 rounded-xl shadow-2xl overflow-hidden">
            @csrf
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="category" id="category" list="category-list" value="{{ old('category') }}" required class="mt-1 block w-full border-gray-700 bg-[#0a101d] text-gray-300 rounded-md shadow-sm focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm" placeholder="e.g. Upcountry, Lowcountry">
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">Max size: 2MB. Recommended format: JPG, PNG, WEBP.</p>
